...
async def for_today(latitude: float, longitude: float) -> dict:
    ...
    if use_cached_data:  # Set in config/dev.json or config/prod.json
        ...
        return {'sunrise': '06:04:09 AM', 'sunset': '08:28:48 PM',
                'solar_noon': '01:16:28 PM',
                'day_length': '14:24:39', 'civil_twilight_begin': '05:31:10 AM',
        ...
        for k, v in list(sun_data.items()):
            ...
            sun_data[k] = datetime.datetime.strftime(__utc_to_local(v),
                                                     '%I:%M:%S %p')
