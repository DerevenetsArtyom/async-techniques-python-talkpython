...
def main():
    ...
    print(Fore.WHITE + "App exiting, total time: {:,.2f} sec.".format(
...
def generate_data(num: int, data: list):
    for idx in range(1, num + 1):
        ...
        print(Fore.YELLOW + " -- generated item {}".format(idx), flush=True)
...
def process_data(num: int, data: list):
    ...
    while processed < num:
        ...
        print(Fore.CYAN + " +++ Processed value {} after {:,.2f} sec.".format(
